...
clear
echo "                                                                                      Welcome To Linux Database Management System"
echo -e "                                                                            A Simple Yet Fully Operational Database Management System ;-)"
echo -e "                                                                 Credits Compiled To Mr.Girish Tere Sir,Mr.Shiv Kumar Sir and Linux Fundamental's Team *_* "
echo -e "                                                             If You Found Or Come Through Any Issue's Or Problems i.e (Bugs) Please Inform Our Team For The Same"
echo -e "                                                                                        Contact---> hritikkanojiya13@gmail.com"
echo -e "                                                                                    ThankYou For Using Our DataBase Management System "
function mainMenu {
  echo "|-----------DataBase------------|"
  echo "|-----------Main Menu-----------|"
  echo "| 1. Select DB                  |"
